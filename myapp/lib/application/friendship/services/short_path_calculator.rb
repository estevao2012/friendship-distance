  ...
  module Friendship
    module Services
      class ShortPathCalculator
        ...
        # https://medium.com/cracking-the-coding-interview-in-ruby-python-and/dijkstras-shortest-path-algorithm-in-ruby-951417829173#:~:text=Dijkstra's%20Algorithm%20is%20the%20compass,other%20nodes%20in%20the%20graph.
